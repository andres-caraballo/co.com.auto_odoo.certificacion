...
//    public static final Target SALARIO_NETO=Target.the("neto a pagar").located(By.xpath("//*[@class='o_data_row' and contains(.,'Salario neto')]//*[@name='total']"));
    ...
    public static final Target DIAS_TRABAJADOS=Target.the("dias trabajados mensual total").located(By.xpath("//*[@class='o_data_row' and contains(.,'Salario básico total')]//*[@name='quantity']"));
